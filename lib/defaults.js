...
export const DEFAULT_SETTINGS = {
  ...
  reqOk: 0.70,
  reqFail: 0.40,
  // Count nice-to-haves toward the pass rate. Off by default: an optional
  // "будет плюсом" line should not weigh the same as a hard requirement.
  scoreNiceToHave: false,
